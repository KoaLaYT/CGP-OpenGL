...
pub fn main() !void {
    ...
    const window: *glfw.Window = try glfw.createWindow(600, 600, "Chapter3 - exercise1", null, null);
...
fn init(window: *glfw.Window) !void {
    shaderProgram = try utils.createShaderProgram("glsl/e03001_vs.glsl", "glsl/02004_fs.glsl");
